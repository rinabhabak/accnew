    ...
    if (mobileTemplate == 3) {
        ...
        $(window).on('load resize', function (e) {
            ...
            if ($(window).width() <= 768) {
                ...
                $(".ves-drill-down-menu #" + alias + " .ves-click").off('click.megaMenu');
                $(".ves-drill-down-menu #" + alias + " .ves-click").on('click.megaMenu', function (e) {
                    e.preventDefault();
                    var parent = $(this).closest('.nav-item');
                    parent.siblings().removeClass('opened');
                    if(parent.hasClass('level1')){
                        parent.parents('.nav-item').find('.opened').not(parent).removeClass('opened')
                    }
