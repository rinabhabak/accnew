...
class Save extends \Int\Configurator\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('int/configurator');
                        ...
                        $imagePath = 'int/configurator'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('int_configurator/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('int_configurator/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('int_configurator/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('int_configurator/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('int_configurator/*/');
