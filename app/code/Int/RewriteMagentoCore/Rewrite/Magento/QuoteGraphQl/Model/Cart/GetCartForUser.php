<?php
/**
 * Copyright © Indusnet Technologies, Inc. All rights reserved.
 * See COPYING.txt for license details.
 */
declare(strict_types=1);

namespace Int\RewriteMagentoCore\Rewrite\Magento\QuoteGraphQl\Model\Cart;
    ...
    public function execute(string $cartHash, ?int $customerId, int $storeId): Quote
    {
        ...
        if ($cartCustomerId !== $customerId) {
            throw new GraphQlAuthorizationException(
                __('You have been logged out. Please log in again.')
            );
        }
        return $cart;
    }
