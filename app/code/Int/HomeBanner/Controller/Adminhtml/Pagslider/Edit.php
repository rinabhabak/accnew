...
class Edit extends Action
{
    ...
    /**
     * @var \Int\HomeBanner\Model\PagSlider
     */
    protected $_model;
     ...
     * @param \Int\HomeBanner\Model\PagSlider $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magento\Framework\Registry $registry,
        \Int\HomeBanner\Model\PagSlider $model
    ) {
    ...
    */
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Int_HomeBanner::slider_head')
            ->addBreadcrumb(__('Slider'), __('Home Home Banner'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('pag_home_banner', $model);
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */

        $resultPage = $this->_initAction();

        $resultPage->addBreadcrumb(
            $id ? __('EDIT Home Banner') : __('ADD Home Banner'),
            $id ? __('EDIT Home Banner') : __('ADD Home Banner')
        );
