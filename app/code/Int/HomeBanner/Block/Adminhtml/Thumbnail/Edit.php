 ...
 * @author    Indusnet
 */
namespace Int\HomeBanner\Block\Adminhtml\Thumbnail;
...
class Edit extends Container
{
    ...
    /**
     * Thumbnail edit block
     *
     * @return void
     */
    protected function _construct()
    {
        $this->_objectId = 'thumbnail_id';
        $this->_blockGroup = 'Int_HomeBanner';      /* Blockgroup is should be module name*/
        $this->_controller = 'adminhtml_thumbnail';     /* Admin form controller */
        parent::_construct();
 
        if ($this->_isAllowedAction('thumbnail/index')) {
