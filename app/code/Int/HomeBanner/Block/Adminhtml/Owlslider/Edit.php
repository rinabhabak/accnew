 ...
 * @author    Indusnet
 */
namespace Int\HomeBanner\Block\Adminhtml\Owlslider;
...
class Edit extends Container
{
    ...
    {
        $this->_objectId = 'slider_id1';
        $this->_blockGroup = 'Int_HomeBanner';      /* Blockgroup is should be module name*/
       $this->_controller = 'adminhtml_owlslider';     /* Admin form controller */

        parent::_construct();

        if ($this->_isAllowedAction('owlslider/owlslider')) {
    ...
    {
        if ($this->_coreRegistry->registry('second_home_banner')->getId()) {
            echo 777;die;
