<?php
namespace Int\ShipstationMailTemplate\Model\Action;
...
class ShipNotify extends \Auctane\Api\Model\Action\ShipNotify
{
    /**
     * Invoice Comment
     */
    ...
    public function process(): string
    {
        ...
        if ($order->canInvoice() && !$this->_customInvoicing) {
            ...
            if ($notify) {
                ...
                $this->logger->debug('Shipstation Invoice Mail Send, Invoice Id - '.$invoice->getEntityId());

                $this->_objectManager->create(\Magento\Sales\Api\InvoiceManagementInterface::class)->notify($invoice->getEntityId());
