...
namespace Int\OutOfStock\Controller\Form;

use Magento\Framework\Exception\LocalizedException;
use Amasty\Xnotif\Controller\Email\AbstractEmail;

/**
 * Class Post
 */
class Post extends AbstractEmail
{
    ...
    public function execute()
    {
        ...
        $redirect->setUrl($this->getRequest()->getParam('getCurrentUrl'));
        return $redirect;
    }
