 ...
 */
class ProductPriceRange implements ResolverInterface
{
    /**
     * @var Discount
     */
    ...
    private function getMaximumProductPrice(SaleableInterface $product, StoreInterface $store): array
    {
        ...
        if($product->getTypeId() == "grouped"){
            ...
            $selectionArray = [];
            foreach ($childProductCollection as $proselection) { 
                $selectionArray[] = $proselection->getFinalPrice();
            }
            $finalPrice = max($selectionArray);
        }
        else{
