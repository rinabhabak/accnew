...
class BdmPastConfiguratorsList implements ResolverInterface
{

    private $configuratorDataProvider;

    /**
     * @param DataProvider\BdmPastConfiguratorsList $configuratorDataProvider
     */
    public function __construct(
        DataProvider\BdmPastConfiguratorsList $configuratorDataProvider
    ) {
