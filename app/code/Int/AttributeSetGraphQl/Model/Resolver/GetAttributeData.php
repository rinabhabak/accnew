...
class GetAttributeData implements ResolverInterface
{
    ...
    public function resolve(
        ...
        if(empty($args['where']['attribute_code'])){
            throw new GraphQlInputException(
                __('Attribute Code is required.')
            );
        }

        $getAttributeData = $this->getAttributeListDataProvider->getGetAttributeList($args['where']['attribute_code']);
        return [
