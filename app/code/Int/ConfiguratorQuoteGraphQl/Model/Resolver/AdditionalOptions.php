 ...
 * @inheritdoc
 */
class AdditionalOptions implements ResolverInterface
{
    /**
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        $quoteItemOption = $cartItem->getOptionByCode('additional_options');

        if (null === $quoteItemOption) {
            return [];
        }
        
        $quoteItemOption = unserialize($quoteItemOption);
