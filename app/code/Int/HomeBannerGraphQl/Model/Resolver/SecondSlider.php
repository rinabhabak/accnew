 ...
 */
class SecondSlider implements ResolverInterface
{

    private $_bannerDataProvider;

    /**
     * @param Int\HomeBannerGraphQl\Model\Resolver\DataProvider\SecondSlider $bannerDataProvider
     */
    public function __construct(
        \Int\HomeBannerGraphQl\Model\Resolver\DataProvider\SecondSlider $bannerDataProvider
    ) {
