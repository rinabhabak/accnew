...
class Slider implements ResolverInterface
{
    ...
    /**
     * @param Int\HomeBannerGraphQl\Model\Resolver\DataProvider\Slider $bannerDataProvider
     */
    public function __construct(
        \Int\HomeBannerGraphQl\Model\Resolver\DataProvider\Slider $bannerDataProvider
    ) {
