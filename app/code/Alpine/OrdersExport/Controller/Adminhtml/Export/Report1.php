<?php
/**
 * Alpine_OrdersExport Export Controller for Report 1
 *
 * @category    Alpine
...
/**
 * Alpine\OrdersExport\Controller\Adminhtml\Export\Report1
 *
 * @category    Alpine
 * @package     Alpine_OrdersExport
 */
class Report1 extends Action
{
    /**
     * Export Model
     *
    ...
    public function execute()
    {
        ...
        $result = $this->fileFactory->create(
            $this->fileName,
            $this->model->getContent($this->fileName, $this->fields, $filters)
        );
