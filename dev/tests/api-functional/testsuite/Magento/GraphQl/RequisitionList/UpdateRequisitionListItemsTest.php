...
class UpdateRequisitionListItemsTest extends GraphQlAbstract
{
    ...
    public function testUpdateRequisitionListItems(): void
    {
        ...
        $requisitionListData = $this->getRequisitionListFromCustomer($requisitionListId);
     ...
     * @throws AuthenticationException
     */
    public function getRequisitionListFromCustomer(int $id): array
    {
     ...
     * @return string
     */
    private function getCustomerRequisitionListQuery(int $id): string
    {
        return <<<QUERY
{
  customer {
