...
MUTATION;
        ...
        $this->assertEquals(base64_encode($createdTeam->getId()), $response['createCompanyTeam']['team']['id']);

        /** @var StructureInterface $teamStructure */
        $teamStructure = $this->structureManager->getStructureByTeamId($createdTeam->getId());

        $this->assertEquals($targetId, $teamStructure->getParentId());
    }
...
MUTATION;
     ...
     */
    private function findOneLevelOneStructureId(): int
    {
