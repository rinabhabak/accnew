...
class UpdateCompanyUserTest extends GraphQlAbstract
{
    ...
    public function setUp(): void
    {
        ...
        $this->idEncoder = $this->objectManager->get(IdEncoder::class);
...
MUTATION;
    ...
    public function testUpdateWithNotEncodedId()
    {
        ...
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('Value "' . $userId . '" is incorrect.');
...
MUTATION;
    ...
    public function testUpdateWithNotEncodedRoleId()
    {
        ...
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('Value "' . $roleId . '" is incorrect.');
